...
describe('employee action menu', () => {
  ...
  it('keeps all actions reachable, closes on Escape/outside click, and targets the correct employee', () => {
    act(() => root.render(<UsersTable users={[user]} zones={[]} onlineUserIds={[]} currentUserRole="hr" onViewDetails={vi.fn()} onEdit={vi.fn()} onSendPasswordReset={vi.fn()} onToggleSuspension={vi.fn()} />));
