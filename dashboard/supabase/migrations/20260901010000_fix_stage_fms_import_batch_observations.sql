-- Migration: 20260901010000_fix_stage_fms_import_batch_observations.sql
-- Description: Fix observation insertion schema in stage_fms_import_batch while preserving context idempotency.
