...
vi.mock('./workforceDirectoryService', () => ({ getRiderWorkforceDirectory: mocks.getRiderWorkforceDirectory }));
vi.mock('../lib/apiService', () => ({ logActivity: mocks.logActivity }));
vi.mock('./attendanceService', () => ({ getLocalDateString: mocks.getLocalDateString }));
