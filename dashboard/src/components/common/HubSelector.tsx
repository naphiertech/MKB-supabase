...
export function HubSelector() {
  ...
  return (
    <label className="relative flex min-w-0 items-center gap-2 rounded-lg border border-border bg-white px-2.5 py-2 text-xs font-semibold text-foreground shadow-sm">
      ...
      <select
        ...
        className="min-w-0 max-w-[9rem] appearance-none truncate bg-transparent pr-5 outline-none disabled:cursor-not-allowed sm:max-w-[14rem]"
      >
